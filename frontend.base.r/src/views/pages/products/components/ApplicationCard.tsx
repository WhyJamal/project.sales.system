...
const ApplicationCard: React.FC<ProductCardProps> = ({ 
  ...
  return (
      <div className="group relative">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-start bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 p-6 sm:p-8 max-w-4xl w-full border border-gray-100 group-hover:border-orange-100">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pt-4 border-t border-gray-100">
              ...
              <Button
                ...
                className="px-6 py-3 rounded-xl text-sm font-semibold hover:to-red-700 text-white shadow-md hover:shadow-lg transition-all duration-300 transform group/link"
              >
